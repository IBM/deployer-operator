...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.Deployer{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileDeployer) reconcileDeployerSet() (reconcile.Result, error) {
	deployerlist := &appv1alpha1.DeployerList{}
	...
	setspec := &appv1alpha1.DeployerSetSpec{}

	for _, deployer := range deployerlist.Items {
		desc := appv1alpha1.DeployerSpecDescriptor{}
